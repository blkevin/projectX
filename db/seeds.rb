...
s6 = User.create!(first_name: "Jean", last_name: "Dupont", age: 18, email: "jn@gmail.com", password: "123456", description: "Intéréssé par le travail du bois (menuiserie/charpente)", status: :student)
